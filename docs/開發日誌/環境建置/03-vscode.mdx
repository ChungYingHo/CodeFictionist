...
9. [TODO Highlight](https://marketplace.visualstudio.com/items?itemName=wayou.vscode-todo-highlight)：讓註解變得鮮明易於辨識。
...
13. [MDX](https://marketplace.visualstudio.com/items?itemName=unifiedjs.vscode-mdx)：優化 MDX 撰寫。
14. [Git Graph](https://marketplace.visualstudio.com/items?itemName=mhutchie.git-graph)：可以在 VScode 中看到 git flow。
15. [Power Mode](https://marketplace.visualstudio.com/items?itemName=hoovercj.vscode-power-mode)：純好玩，讓寫 code 有爆炸特效。
