...
timeline
    section 學術背景
        2019-2021: 國立臺灣大學 農藝所
    section 職業經歷
        2022-2023: 統一企業 - 事業夥伴
        2023-2024: 經緯航太科技 - 前端工程師
        2024-Present: 三宏科技 - 前端工程師
```
...
| 作品名稱 | 作品描述 | 連結 |
| --- | --- | --- |
| Env Aligner | This is simple tool to check if the environment variables in `.env` file are aligned with the `.env.example` file. | [npm](https://www.npmjs.com/package/env-aligner) |
